...
<div class="container-wrapper">
  ...
  <h1 style="color:red;font-family:bold;font-size:300%;text-align:center">THE ORIGIN OF MUSICAL INSTRUMENT</h1>
  <p><em>the legends</em></p>
  <p>The date and origin of the first device considered a musical instrument is disputed.
   The oldest object that some scholars refer to as a musical instrument, a simple flute, 
   dates back as far as 67,000 years. Some consensus dates early flutes to about 37,000 years ago. 
  . Many early musical instruments were made from animal skins, bone, wood, 
   and other non-durable materials..</p>
  <br>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <a href="#demo" data-toggle="collapse">
        <<img src="<c:url value="/resources/images/shu-badsharp.gif" />"  class="img-circle person" alt="Random Name" width="255" height="255">
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo2" data-toggle="collapse">
        <<img src="<c:url value="/resources/images/jja.jpg" />"  class="img-circle person" alt="Random Name" width="255" height="255">
      <p style="color:red">PRESS IMAGE<p>
      </a>
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo3" data-toggle="collapse">
        <<img src="<c:url value="/resources/images/oud.jpg" />" class="img-circle person" alt="Random Name" width="255" height="255">
      <p style="color:red">PRESS IMAGE<p>
      </a>
